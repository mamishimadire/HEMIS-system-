...
namespace HemisAudit.Services
{
    public class Rule32Service : IRule32Service
    {
        ...
        public Rule32Service(IConfiguration configuration, IPendingValidationCacheService pendingValidationCache)
        {
...
WHERE RunID = @RunID;";
                ...
                markEdit.Parameters.AddWithValue("@RecordHash", ComputeHash($@"BeginWorkspaceEdit|Rule32|{runId}|{reviewerEmail}|{DateTime.UtcNow:o}|{previousHash}"));
...
END";
        ...
        public Task<string> GenerateSqlAsync(Rule32ValidationRequest request)
        {
            ...
            var sql = $@"-- ============================================================================
-- HEMIS RULE 32: FATAL ERRORS WITH EXCLUSIONS (STUD)
-- ============================================================================
-- Table: [{safeTable}]
