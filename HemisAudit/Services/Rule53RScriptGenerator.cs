...
public static class Rule53RScriptGenerator
{
    private static string RString(string? value) =>
        (value ?? "").Replace("\\", "\\\\").Replace("'", "\\'");

    public static string Generate(Rule53ValidationRequest req)
    {
...
cat(sprintf('-- Rule 53: CRSE VALPAC Data vs CRSE PRODUCTION --\n'))
