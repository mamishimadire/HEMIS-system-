...
public static class Rule58RScriptGenerator
{
    private static string RString(string? value) =>
        (value ?? "").Replace("\\", "\\\\").Replace("'", "\\'");

    public static string Generate(Rule58ValidationRequest req)
    {
...
cat(sprintf('-- Rule 58: Staff VALPAC Data vs Staff PRODUCTION --\n'))
