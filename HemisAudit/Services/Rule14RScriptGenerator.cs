...
public static class Rule14RScriptGenerator
{
    private static string RString(string? value) =>
        (value ?? "").Replace("\\", "\\\\").Replace("'", "\\'");

    public static string Generate(Rule14ValidationRequest req)
    {
...
# Rule 14: Foundation CESM - Qualification Type Check
...
print_summary(exceptions, 'Rule 14: Foundation CESM - Qualification Type Check')
