namespace HemisAudit.ViewModels
{
    ...
    //   Tables : dbo_STUD  ──►  dbo_QUAL (bridge)  ──►  PQM
    //   Filter : QUAL._005 IN (Masters/Doctoral PG types)
    //   Display: STUD._007, STUD._008, STUD._001, STUD._010, STUD._073
    //   Compare: STUD._073 (actual research %)  vs  PQM.Research_1 (expected %)
    // ═══════════════════════════════════════════════════════════════════════════

    public class Rule44ColumnMapping
    {
        // STUD columns
    ...
    public class Rule44ValidationRequest
    {
        ...
        public Rule44ColumnMapping ColumnMapping { get; set; } = new();
    }

    public class Rule44ReviewRow
    {
    ...
    public class Rule44ValidationSummary
    {
        ...
        public List<Rule44ReviewRow> PassRows     { get; set; } = new();
        public List<Rule44ReviewRow> FailRows     { get; set; } = new();
    }
    ...
    public class Rule44VerifyResult
    {
        public bool   Success        { get; set; }
    ...
    public class Rule44TableDiscoveryResult
    {
        public bool   Success        { get; set; }
    ...
    public class Rule44ColumnDiscoveryResult
    {
        public bool   Success       { get; set; }
    ...
    public class Rule44WorkspaceSaveResult
    {
        ...
        public Rule44WorkspaceStateViewModel? Workspace { get; set; }
    }

    public class Rule44WorkspaceStateViewModel
    {
        public int    ClientId    { get; set; }
        public int?   RunId       { get; set; }
        ...
        public Rule44ValidationSummary? Summary  { get; set; }
    }

    public class Rule44RunReviewViewModel
    {
        public int    RunId          { get; set; }
        public int    ClientId       { get; set; }
    ...
    public class Rule44RunSignoffInputModel
    {
        public int    RunId   { get; set; }
        public string Comment { get; set; } = "";
    }

    public class Rule44WorkspaceSignoffInputModel
    {
        public int    ClientId { get; set; }
        public int?   RunId    { get; set; }
        public string Comment  { get; set; } = "";
