...
namespace HemisAudit.ViewModels
{
    ...
    public class Rule53VerifyRequest
    {
    ...
    public class Rule53ControlSummaryItemViewModel
    {
    ...
    public class Rule53ValidationRowRecord
    {
    ...
    public class Rule53ValidationSummary
    {
        ...
        public List<Rule53ControlSummaryItemViewModel> ControlSummaries { get; set; } = new();
        public List<Rule53ValidationRowRecord> ReviewRows { get; set; } = new();
    ...
    public class Rule53RunReviewViewModel
    {
        ...
        public Rule53ValidationSummary Summary { get; set; } = new();
