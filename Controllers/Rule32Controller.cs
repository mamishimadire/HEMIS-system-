...
namespace HemisAudit.Controllers
{
    ...
    public class Rule32Controller : Controller
    {
        ...
        [HttpPost]
        public IActionResult DownloadExcel([FromBody] Rule32ValidationSummary summary)
        {
            var bytes = _export.ExportExcel(summary);
            SaveToDesktop($"Rule32_Fatal_Errors_{Ts()}.xlsx", bytes);
            return File(bytes,
                "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
        ...
        [HttpPost]
        public IActionResult DownloadCsv([FromBody] Rule32ValidationSummary summary)
        {
        ...
        [HttpPost]
        public IActionResult DownloadExceptionsCsv([FromBody] Rule32ValidationSummary summary)
        {
