    ...
    public class Rule29Controller : Controller
    {
        ...
        public async Task<IActionResult> Index(int clientId = 0)
        {
            ...
            if (IsResultsOnlyRole(role))
            {
                ...
                TempData["Error"] = "No analyst-signed Rule 29 result is available for this engagement yet.";
        ...
        private async Task<Rule29ValidationSummary> ResolveExportSummaryAsync(Rule29ValidationSummary summary)
        {
            ...
            {
                var workspace = await _rule29.GetCurrentWorkspaceStateAsync(summary.ClientId, user?.Email, includeSummary: true);
